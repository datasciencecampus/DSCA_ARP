...
new_names <- c("Democratic Republic of the Congo",  "Ivory Coast", "Republic of Congo", "Vatican", "Slovakia", "Macedonia", "UK",
               "Antigua", "Saint Kitts", "Saint Lucia", "Saint Vincent", "Trinidad", "USA", "Kyrgyztan", "Laos", "Micronesia")
...
#
  ...
  geom_text_repel(data = hiv_geos, aes(x = cen_Longitude, y = cen_Latitude, label = geo), size = 3, direction = "x", segment.alpha = 0.2) +   theme_void()
```
